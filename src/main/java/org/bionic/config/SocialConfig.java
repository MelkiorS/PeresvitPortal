...
import org.bionic.social.SimpleSignInAdapter;
...
//    public ConnectController connectController(ConnectionFactoryLocator connectionFactoryLocator, ConnectionRepository connectionRepository) {
//        return new ConnectController(connectionFactoryLocator, connectionRepository)
//                .addDisconnectInterceptor(new DisconnectInterceptor<>() {
//                });
//    }

//    @Bean
//    public org.springframework.social.connect.web.DisconnectController disconnectController(UsersConnectionRepository usersConnectionRepository, Environment environment) {
