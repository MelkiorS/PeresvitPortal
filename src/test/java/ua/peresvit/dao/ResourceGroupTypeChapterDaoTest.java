...
import ua.peresvit.testdata.ResourceGroupTypeChapterFactory;
...
public class ResourceGroupTypeChapterDaoTest extends BaseDaoTest<ResourceGroupTypeChapter> {

    @Autowired
    private ResourceGroupTypeChapterRepository cr;
