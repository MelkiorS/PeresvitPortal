...
import ua.peresvit.testdata.UserGroupFactory;
...
public class UserGroupDaoTest extends BaseDaoTest<UserGroup> {

    @Autowired
    private UserGroupRepository cr;

    @Before
    public void setup() {
        super.init(cr, new UserGroupFactory());
    }
