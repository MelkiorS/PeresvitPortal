...
import ua.peresvit.testdata.CombatArtFactory;
...
public class CombatArtDaoTest extends BaseDaoTest<CombatArt> {

    @Autowired
    private CombatArtReppository cr;

    @Before
    public void setup() {
        super.init(cr, new CombatArtFactory());
    }
